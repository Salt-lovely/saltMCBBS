...
type settingOptions =
    | settingOptionsCheck
    | settingOptionsNormal
    | settingOptionsInput
    | settingOptionsTextarea
    | settingOptionsRange;
...
interface BBSAPIResponceData {
    Variables: BBSAPIResponceDataVariables;
}
...
interface TIDAPIResponceData {
    Variables: TIDAPIResponceDataVariables;
}
