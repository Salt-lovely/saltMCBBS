...
*/
.pl .blockcode > div > .codeline {display:block !important;position: absolute;top: 10px;left: 0;overflow: hidden;width: 36px;height: var(--lineCountXlineHeight,100%);user-select: none;}
