...
`
        ...
        animationOP() {
            ...
            .plhin td.pls > div.favatar{
                position: sticky;
                top: ${this.moveTopBarToLeft ? '0' : '50px'};
            }
            div.tip[id^="g_up"] {
                left: 20px !important;
                top: 160px !important;
