    ...
    class saltMCBBS extends saltMCBBSOriginClass implements saltMCBBS {
        ...
        constructor(autorun = false) {
            ...
            window.saltMCBBSCSS.setStyle( // 主要更改
                `body>div[style]:not([id]):not([class]){float:left}body>.mc_map_wp{padding-top:0;margin-top:0;overflow:visible;display:inline-block;margin-left:calc(50% - 565px)}body>.mc_map_wp>.new_wp{padding-top:0 !important;padding-bottom:0 !important}body>.mc_map_wp>.new_wp h2 img{max-height:74px}.pmwarn{width:auto !important;background-size:16px !important}ul.xl.xl2.o.cl .pmwarn{background:url(template/mcbbs/image/warning.gif) no-repeat 0px 2px}#uhd>.mn>ul .pmwarn a{background:url(template/mcbbs/image/warning.gif) no-repeat 0px 2px !important;background-size:16px !important}.warned{opacity:0.2}.warned:hover{opacity:0.9}#scrolltop{visibility:visible !important;opacity:1;transition:0.3s ease}#scrolltop:not([style]){display:none}#scrolltop[style*="hidden"]{margin-left:-10px;opacity:0}.pl .blockcode{position:relative}.pl .blockcode>em{top:2px;right:2px;position:absolute;margin:0 0 0 0}.pl .blockcode>em:hover{outline:1px dashed}.pl .blockcode ol{overflow-x:scroll}.pl .blockcode ol li{color:#444;margin-left:29px;line-height:1.8em;height:1.8em;white-space:pre}.settingPanel{width:40vw;min-width:360px;right:30vw;max-height:90vh;top:10vh;position:fixed;background-color:#fbf2db;background-clip:padding-box;padding:0 8px 8px 8px;border:8px solid;border-radius:8px;border-color:rgba(0,0,0,0.2);box-sizing:border-box;overflow-y:auto;transition:0.3s ease, opacity 0.2s ease;z-index:999999}.settingPanel.visible{opacity:1;top:10vh}.settingPanel.hidden{opacity:0;top:-90vh;transition-timing-function:ease-in}.settingPanel>*{width:100%;box-sizing:border-box;margin-bottom:8px;float:left}.settingPanel h3{font-size:0.875rem}.settingPanel h3 small{font-size:0.5em;color:grey}.settingPanel h3.half-h3{width:calc(50% - 14px);padding:0 10px 0 0;float:left;text-align:right}.settingPanel textarea{resize:vertical;height:4em;min-height:2em;max-height:20em;width:calc(100% - 8px)}.settingPanel input{width:calc(50% - 4px);float:left;text-align:center}
                `
                , 'main'
            )
...
`, 'medal')
        ...
        init() {
            ...
            settingPanelTitle.innerHTML = `<h3 class="flb" style="width:calc(100% - 15px)"><em>saltMCBBS设置面板</em>
            <span style="float:right"><a href="javascript:;" class="flbc" onclick="saltMCBBS.hideSettingPanel()" title="关闭">关闭</a></span></h3>`;
