...
`
        ...
        animationOP() {
            ...
            window.saltMCBBSCSS.setStyle(`
/**/
.pl .blockcode {position: relative;background-image: none;}
.pl .blockcode > div {position: relative;max-height: 60rem;scrollbar-width: thin;scrollbar-color: #eee #999;z-index: 10;}
.pl .blockcode > div::-webkit-scrollbar {width: 10px;height: 10px;}
.pl .blockcode > div::-webkit-scrollbar-thumb {border-radius: 10px;box-shadow: inset 0 0 4px rgba(102, 102, 102, 0.25);background: #999;}
.pl .blockcode > div::-webkit-scrollbar-track {box-shadow: inset 0 0 4px rgba(187, 187, 187, 0.25);border-radius: 10px;background: #eee;}
