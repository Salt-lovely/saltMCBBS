...
`, 'medal')
        ...
        init() {
            ...
            settingPanelTitle.innerHTML = `<h3 class="flb"><em>saltMCBBS设置面板</em>
            <span><a href="javascript:;" class="flbc" onclick="saltMCBBS.hideSettingPanel()" title="关闭">关闭</a></span></h3>`;
