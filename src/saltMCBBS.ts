...
.view_warns_home + .pmwarn{
    ...
    (function () {
        if (document.querySelector('.mc_map_wp')) {
            window.saltMCBBS.message('您正在使用的SaltMCBBS并不适用于v2版本的MCBBS，请换用旧版(0.1.8)的SaltMCBBS<br><a href="">点击这里下载旧版SaltMCBBS</a>', (f) => { f() }, 4)
        }
    })();
})();
