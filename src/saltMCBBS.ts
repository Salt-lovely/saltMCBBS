...
`, 'threadClassify'
        ...
        movePageHead() {
            ...
            let obj = this
            // 配置
            let enableSaltMoveTopBarToLeft = this.readWithDefault<boolean>('SaltMoveTopBarToLeft', true)
...
`
        ...
        imgProxyOP() {
            let enableProxy = this.readWithDefault<boolean>('LoadImgProxyEnable', true),
                ...
                obj = this,
                cssSelector = window.location.href.indexOf('action=printable') == -1 ? '.t_fsz .t_f img, .img img' : 'body > img, body > * > img'
            ...
            handler()
            obj.saltObserver('ct', handler) // 别问，只是一个适配功能
            /**使用代理 */
